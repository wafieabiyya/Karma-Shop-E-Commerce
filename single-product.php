...
if (isset($_GET['product_id'])) {
	...
	$statment = $conn->prepare($query_product);
	$statment->execute();
	$product_detail = $statment->get_result();
}
?>
...
<?php include 'layouts/header.php' ?>
	...
	<div class="product_image_area">
		<div class="container">
			<?php while ($row = $product_detail->fetch_assoc()) { ?>
				<div class="row s_product_inner">
					...
					<div class="col-lg-5 offset-lg-1">
						<div class="s_product_text">
							...
							<h2><?php echo setRupiah($row['special_offer'] * $kurs_dollar) ?></h2>
							<ul class="list">
								<li><a class="active" href="#"><span>Category</span> : <?php echo $row['product_category'] ?></a></li>
							...
							<form action="cart.php" method="POST">
								...
								<input type="hidden" name="special_offer" value="<?php echo $row['special_offer']; ?>">
