                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" id="favourite" name="product_criteria" value="Latest Product" required>
                                        <label class="custom-control-label" for="favourite">Latest Product</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" id="none" name="product_criteria" value="Coming Soon" required>
