...
if (isset($_POST['login_btn'])) {
    ...
    $query = "SELECT admin_id, admin_name, admin_email, admin_phone, admin_password, admin_photo FROM admins WHERE admin_email = ? AND admin_password = ? LIMIT 1";
...
<head>
    ...
    <title>Karma's Admin - Login</title>
