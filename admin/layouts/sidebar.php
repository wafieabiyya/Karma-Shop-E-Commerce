    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="create_product.php">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-6 col-md-6 text-center">
                        <img src="<?php echo '../img/profile/' . $_SESSION['admin_photo']; ?>" alt="" class="rounded-circle img-responsive" width="150" height="200" style="object-fit: cover;" />
                    </div>
                    <div class="col-sm-6 col-md-6 py-2">
                        <h4 style="font-weight: 800; color: #2D2727; "><?php if (isset($_SESSION['admin_name'])) {
